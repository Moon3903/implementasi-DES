...
public class Des {
  ...
  private String hexToStr(String input) {
...
//        + key.toUpperCase());
  ...
  public String encrypt(String plainTextInput, String key) {
    String plainText = binToHex(strToBin(plainTextInput));
//    String key = binToHex(strToBin(keyInput));
  ...
  public String decrypt(String plainTextInput, String key) {
//    String plainText = binToHex(strToBin(plainTextInput));
...
//            + "\n");
    ...
    plainText = plainText.substring(8, 16)
        + plainText.substring(0, 8);
    plainText = permutation(IP1, plainText);
    return hexToStr(plainText);
  }

  public String tripleDesEncrypt (String plainTextInput, String key1, String key2) {
    String encrypt1 = encrypt(plainTextInput, key1);
    String encrypt2 = decrypt(encrypt1, key2);

    return encrypt(encrypt2, key1);
  }

  public String tripleDesDecrypt (String plainTextInput, String key1, String key2) {
    String encrypt1 = decrypt(plainTextInput, key1);
    String encrypt2 = encrypt(encrypt1, key2);

    return decrypt(encrypt2, key1);
  }
}
